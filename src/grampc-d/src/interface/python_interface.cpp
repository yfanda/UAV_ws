...
namespace grampcd
{
	...
	void PythonInterface::print_solution_to_file(const unsigned int agent_id, std::string prefix) const
	{
		dmpc_interface_->print_solution_to_file(agent_id, prefix);
	}

	void PythonInterface::print_solution_to_file(const std::string& agents, std::string prefix) const
	{
