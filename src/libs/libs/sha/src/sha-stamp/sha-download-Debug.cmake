...
set(command "/usr/bin/cmake;-P;/home/evan/UAV_ws/src/libs/libs/sha/tmp/sha-gitclone.cmake")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/evan/UAV_ws/src/libs/libs/sha/src/sha-stamp/sha-download-out.log")
set(stderr_log "/home/evan/UAV_ws/src/libs/libs/sha/src/sha-stamp/sha-download-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/evan/UAV_ws/src/libs/libs/sha/src/sha-stamp/sha-download-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "sha download command succeeded.  See also /home/evan/UAV_ws/src/libs/libs/sha/src/sha-stamp/sha-download-*.log")
    message(STATUS "${msg}")
  endif()
endif()
