...
#include "common_msgs/msg/detail/input__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const common_msgs::msg::Input & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  common_msgs::msg::Input & ros_message)
{
  // Member: input
  {
    cdr >> ros_message.input;
...
{
  auto typed_message =
    static_cast<const common_msgs::msg::Input *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<common_msgs::msg::Input *>(
    untyped_ros_message);
...
static size_t _Input__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Input(full_bounded, 0);
}
...
{
  return &common_msgs::msg::typesupport_fastrtps_cpp::_Input__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, common_msgs, msg, Input)() {
  return &common_msgs::msg::typesupport_fastrtps_cpp::_Input__handle;
}
