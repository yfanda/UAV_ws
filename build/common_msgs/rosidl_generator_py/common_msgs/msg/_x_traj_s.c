...
bool common_msgs__msg__x_traj__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("common_msgs.msg._x_traj.XTraj", full_classname_dest, 29) == 0);
  }
  common_msgs__msg__XTraj * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of XTraj */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("common_msgs.msg._x_traj");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "XTraj");
