...
inline std::string to_yaml(const UTraj & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const common_msgs::msg::UTraj & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const common_msgs::msg::UTraj & msg)
{
