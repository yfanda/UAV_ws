...
namespace grampcd
{
    ...
    public:
		...
		typeRNum COMMON_Thor_ = 0.3;
        /*Step size*/
        typeRNum COMMON_dt_ = 0.01;
        /*Number of discretization points*/
        unsigned int COMMON_Nhor_ = 11;
        ...
        unsigned int GRAMPC_MaxGradIter_ = 10;
        /*Maximum number of multiplier iterations*/
        unsigned int GRAMPC_MaxMultIter_ = 1;
        ...
        /*Used integration method*/
        std::string GRAMPC_Integrator_ = "heun";
        /*Method to solve the line search problem*/
        std::string GRAMPC_LineSearchType_ = "explicit2";
        ...
        std::string GRAMPC_ConvergenceCheck_ = "on";
