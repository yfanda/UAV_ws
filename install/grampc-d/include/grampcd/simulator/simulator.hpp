...
namespace grampcd
{
    ...
    public:
        ...
        void centralized_simulation(typeRNum* x_next,const SolverCentral *solver, const std::string& Integrator, typeRNum dt,typeRNum* ui);
    
        /*Set t0*/
        void set_t0(typeRNum t0);
        void set_u_fault(const SolverCentral *solver);

    private:
        void simulate(typeRNum* x_next_out, typeRNum* u_input);
