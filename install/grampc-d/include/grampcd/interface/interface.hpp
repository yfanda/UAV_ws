...
namespace grampcd
{
	...
	public:
		...
		virtual void print_solution_to_file(const unsigned int agent_id, std::string prefix = "Solution_agent") const = 0;
		/*Print solutions of a set of agents to a file using a specific prefix for the file name.*/
		virtual void print_solution_to_file(const std::string& agents, std::string prefix = "Solution_agent") const = 0;
